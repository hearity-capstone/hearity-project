...
val testResultDummyData = listOf(
    TestResultModel(
        ...
        summary = "Your hearing is normal at low to medium frequencies. However, there is a mild hearing loss detected at high frequencies in your right ear. This might affect your ability to hear high-pitched sounds clearly. It is recommended to consult with an audiologist for further evaluation and guidance.",
